...
complete -c waka -n "__fish_waka_needs_command" -f -a "cache" -d 'Manage the local response cache'
complete -c waka -n "__fish_waka_needs_command" -f -a "update" -d 'Update waka to the latest version'
complete -c waka -n "__fish_waka_needs_command" -f -a "changelog" -d 'Show the changelog from the installed version to the latest'
...
complete -c waka -n "__fish_waka_using_subcommand report; and __fish_seen_subcommand_from generate" -s F -l output-format -d 'Report format' -r -f -a "md\t''
html\t''
json\t''
csv\t''"
...
complete -c waka -n "__fish_waka_using_subcommand report; and __fish_seen_subcommand_from generate" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
...
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -f -a "clear" -d 'Clear all cached entries (or only those older than a duration)'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -f -a "info" -d 'Show cache statistics (entry count, disk size, last write)'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -f -a "path" -d 'Print the path to the cache directory'
complete -c waka -n "__fish_waka_using_subcommand cache; and not __fish_seen_subcommand_from clear info path help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l older -d 'Remove only entries older than this duration (e.g. `1h`, `24h`, `7d`)' -r
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from clear" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from info" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from path" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "clear" -d 'Clear all cached entries (or only those older than a duration)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "info" -d 'Show cache statistics (entry count, disk size, last write)'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "path" -d 'Print the path to the cache directory'
complete -c waka -n "__fish_waka_using_subcommand cache; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c waka -n "__fish_waka_using_subcommand update" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand update" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand update" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand update" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand update" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand update" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand update" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand update" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand update" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand changelog" -s p -l profile -d 'Use a specific profile' -r
complete -c waka -n "__fish_waka_using_subcommand changelog" -s f -l format -d 'Output format: table, json, csv, plain' -r -f -a "table\t''
json\t''
csv\t''
plain\t''"
complete -c waka -n "__fish_waka_using_subcommand changelog" -l no-cache -d 'Skip the cache and force a fresh API request'
complete -c waka -n "__fish_waka_using_subcommand changelog" -l no-color -d 'Disable colors (equivalent to `NO_COLOR=1`)'
complete -c waka -n "__fish_waka_using_subcommand changelog" -l quiet -d 'Suppress non-essential output'
complete -c waka -n "__fish_waka_using_subcommand changelog" -l verbose -d 'Enable verbose mode (shows HTTP requests)'
complete -c waka -n "__fish_waka_using_subcommand changelog" -l csv-bom -d 'Prepend a UTF-8 BOM to CSV output (for Windows Excel compatibility)'
complete -c waka -n "__fish_waka_using_subcommand changelog" -s h -l help -d 'Print help'
complete -c waka -n "__fish_waka_using_subcommand changelog" -s V -l version -d 'Print version'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "auth" -d 'Manage API key and authentication'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "stats" -d 'Show coding statistics'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "projects" -d 'Browse and filter projects'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "languages" -d 'Browse coding languages'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "editors" -d 'Browse editors and IDEs'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "goals" -d 'View and watch coding goals'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "leaderboard" -d 'View the `WakaTime` leaderboard'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "report" -d 'Generate productivity reports'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "dashboard" -d 'Launch the interactive TUI dashboard'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "prompt" -d 'Shell prompt integration (reads from cache only, no network)'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "completions" -d 'Generate shell completions'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "config" -d 'Manage waka configuration'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "cache" -d 'Manage the local response cache'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "update" -d 'Update waka to the latest version'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "changelog" -d 'Show the changelog from the installed version to the latest'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache update changelog help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c waka -n "__fish_waka_using_subcommand help; and __fish_seen_subcommand_from cache" -f -a "clear" -d 'Clear all cached entries (or only those older than a duration)'
complete -c waka -n "__fish_waka_using_subcommand help; and __fish_seen_subcommand_from cache" -f -a "info" -d 'Show cache statistics (entry count, disk size, last write)'
complete -c waka -n "__fish_waka_using_subcommand help; and __fish_seen_subcommand_from cache" -f -a "path" -d 'Print the path to the cache directory'
