...
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "auth" -d 'Manage API key and authentication'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "stats" -d 'Show coding statistics'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "projects" -d 'Browse and filter projects'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "languages" -d 'Browse coding languages'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "editors" -d 'Browse editors and IDEs'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "goals" -d 'View and watch coding goals'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "leaderboard" -d 'View the `WakaTime` leaderboard'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "report" -d 'Generate productivity reports'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "dashboard" -d 'Launch the interactive TUI dashboard'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "prompt" -d 'Shell prompt integration (reads from cache only, no network)'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "completions" -d 'Generate shell completions'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "config" -d 'Manage waka configuration'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "cache" -d 'Manage the local response cache'
complete -c waka -n "__fish_waka_using_subcommand help; and not __fish_seen_subcommand_from auth stats projects languages editors goals leaderboard report dashboard prompt completions config cache help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
